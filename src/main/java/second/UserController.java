...
public class UserController {
    ...
    public String create(@RequestParam(name = "user_id") String user_id, @RequestParam("name")
    String name, @RequestParam("password") String password, @RequestParam("phone_num") String phone_num, @RequestParam("blind") boolean blind){
